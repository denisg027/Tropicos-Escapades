...
[/md-form]</pre>
				...
				<?php if( false && $this->fs->is_free_plan() ) : ?>
					<div class="cf7md-card-actions">
						<a href="<?php echo $this->upgrade_url; ?>" class="cf7md-button"><?php /* translators: %s: price */ printf( __( 'Upgrade for %s', 'material-design-for-contact-form-7' ), $this->upgrade_cost ); ?></a>
					</div>
				<?php endif; ?>
    ...
    private function get_help_tab_html() {
		...
		<div class="cf7md-admin">
			<div class="<?php echo $container_class; ?>">
				...
				<?php if( true || $this->fs->is_paying__premium_only() ) : ?>
					<p>You can pick your own styles in the <a href="<?php echo $this->customize_url; ?>">customizer</a>.</p>
				<?php else: ?>
				...
				<?php if( false && $this->fs->is_paying__premium_only() ) : ?>
				...
				<p>If the form is hidden when first added to the page (E.g. in a non-active tab), you may need to re-measure any outlined field labels so that the outlines don't overlap the label. You can do that by calling <code>window.cf7mdRemeasure()</code> after the outlined fields are shown.</p>
