...
class CF7_Material_Design_Customizer {
    ...
    public function customize_register( $wp_customize ) {
		...
		// Force default font size
        $wp_customize->add_setting( 'cf7md_options[force_font_sizes]', array(
            'type' => 'option',
            'capability' => 'edit_theme_options',
            'default' => false,
            'transport' => 'postMessage',
        ...
        $wp_customize->add_control( 'cf7md_options[force_font_sizes]', array(
            'type' => 'checkbox',
            'priority' => 10,
            'section' => 'cf7md_options',
            'label' => __( 'Force default font size', 'material-design-for-contact-form-7' ),
            'description' => 'Some themes (like Twenty Twenty) set a very small font-size on the html tag, which messes with the Material Design fields. Check this option to force the default font sizes if they look wrong. This option does not require the premium version.'
        ) );
