        ...
        <div class="cf7md-admin cf7md-page">
			...
			<div class="cf7md-main">
				...
				<div class="cf7md-content">
					<?php if ( get_option( 'cf7md_options[version_switch]' ) ): ?>
					...
					<h3>The labels are tiny!</h3>
					<p>Some themes have CSS that makes the labels really small. You can fix this in the <a href="<?php echo esc_url( $this->customize_url ); ?>">customizer</a> by setting the option to force default font sizes.</p>
