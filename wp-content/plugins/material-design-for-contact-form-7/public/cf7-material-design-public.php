...
class CF7_Material_Design {
	...
	function __construct() {
		...
		// 	if( $this->fs->can_use_premium_code() ) {
				add_shortcode( 'md-switch', array( $this, 'md_switch_shortcode' ) );
				add_shortcode( 'md-card', array( $this, 'md_card_shortcode') );
		// 	}
		// }
	 ...
	 * Card shortcode
	 */
	public function md_card_shortcode( $atts, $content = '' ) {
	...
	public function md_text_shortcode( $atts, $content = '' ) {
		...
		<div class="cf7md-item cf7md-text <?php echo esc_attr( $layout_classes ); ?>">
			...
			<div style="display: none;" class="cf7md-text-html">
				...
				<?php if( true || $this->fs->can_use_premium_code() ) :
						if( $icon ) : ?>
	 ...
	 * Switch shortcode
	 */
	public function md_switch_shortcode( $atts, $content = '' ) {
	...
	private function get_layout_classes($atts) {
		...
		// if( $this->fs->is__premium_only() && $this->fs->can_use_premium_code() ) {
			...
			$classes .= ' mdc-layout-grid__cell--span-' . $mobileWidth . '-phone';
		// } else {
