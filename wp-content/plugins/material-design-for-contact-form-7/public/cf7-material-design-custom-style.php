...
class CF7_Material_Design_Custom_Style {
	...
	public function add_scripts_and_styles() {
		...
		// Maybe enqueue the rem-as-px.css file
		if( is_customize_preview() || isset( $this->options['force_font_sizes'] ) && $this->options['force_font_sizes'] ) {
			wp_enqueue_style( 'cf7md-force-font-sizes', plugins_url( '../assets/css/cf7md-rem-as-px.css', __FILE__ ), array('cf7-material-design'), CF7MD_VER );
		}
